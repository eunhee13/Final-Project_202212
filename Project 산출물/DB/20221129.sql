...
-- MA_DEPT 테이블의 부서코드 명칭 변경..
-- NO_DEPT에서 CD_DEPT로
-- 컬럼 날렸다가 다시 생성
--ALTER TABLE MA_EMP DROP COLUMN NO_DEPT;
--ALTER TABLE MA_EMP ADD CD_DEPT VARCHAR2(20) NOT NULL;
--DROP TABLE MA_EMP;
...
--ALTER TABLE MA_EMP DROP CONSTRAINT FK_MA_EMP_02 ;
...
--DROP TABLE HR_DCALCPAY      ;
--DROP TABLE HR_PCALCPAY       ;



--  컬럼 추가
--ALTER TABLE HR_PCALCPAY ADD YM VARCHAR2(20) DEFAULT 0 NOT NULL;
--ALTER TABLE HR_DCALCPAY ADD YM VARCHAR2(20) DEFAULT 0 NOT NULL;

--SELECT * FROM HR_PCALCPAY
