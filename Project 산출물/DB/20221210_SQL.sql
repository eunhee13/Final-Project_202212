DROP VIEW MA_EMP_TOTAL;
DROP VIEW MA_EMP_TMP_CE;
DROP VIEW MA_EMP_TMP_JIK;
DROP VIEW MA_EMP_TMP;
DROP VIEW TEST_01;
...
insert into ma_emp_private values('system','erperp_system@gmail.com','서울시 강남구 어프어프빌딩 102-1703','01028287733','9007072000000');

insert into ma_emp values ('erp001', '김철수',sysdate,sysdate,null, '001','001','001');
insert into ma_emp_private values('erp001','erperp_sajang01@gmail.com','서울시 동작구 카카오아파트 102-1502','01012341234','9010101231234');

insert into ma_emp values ('erp002', '이강인',to_date('20160730','yyyy-mm-dd'),to_date('19991017','yyyy-mm-dd'),null, '001','003','006');
insert into ma_emp_private values ('erp002','erperp_kangin18@gmail.com','서울시 관악구 마요르카빌라 103-122','01013547985','9910171231234');

insert into ma_emp values('erp003', '손흥민',to_date('20020826','yyyy-mm-dd'),to_date('19850708','yyyy-mm-dd'),null, '001','002','003');
insert into ma_emp_private values('erp003','erperp_son7@gmail.com','서울시 광진구 토트넘아파트 117-017','01013798521','8507081112222');

insert into ma_emp values ('erp004', '조규성',to_date('20141008','yyyy-mm-dd'),to_date('19980125','yyyy-mm-dd'),null, '001','005','009');
insert into ma_emp_private values('erp004','erperp_forward09@gmail.com','서울시 양천구 현대모터스빌라 110-1903','01013798521','9801251532692');

insert into ma_emp values ('erp005', '황의조',to_date('19960214','yyyy-mm-dd'),to_date('19720215','yyyy-mm-dd'),null, '001','003','005');
insert into ma_emp_private values('erp005','erperp_eujo16@naver.com','서울시 종로구 카카오아파트 117-415','01045169712','7202151421697');

insert into ma_emp values ('erp006', '송민규',to_date('20050108','yyyy-mm-dd'),to_date('19851227','yyyy-mm-dd'),null, '001','004','007');
insert into ma_emp_private values('erp006','erperp_songmk26@gmail.com','전라북도 군산시 현대아파트 102-1017','01064581256','8512271784125');

insert into ma_emp values ('erp007', '백승호',to_date('20160214','yyyy-mm-dd'),to_date('19970915','yyyy-mm-dd'),null, '001','005','009');
insert into ma_emp_private values('erp007','erperp_goal08@gmail.com','충청남도 예산군 까치아파트 118-1302','01041261005','9709151124879');

insert into ma_emp values ('erp008', '나상호',to_date('20010113','yyyy-mm-dd'),to_date('19850402','yyyy-mm-dd'),null, '001','004','008');
insert into ma_emp_private values('erp008','erperp_rocket17@hanmail.net','서울시 성동구 현대아파트 115-1061','01091754112','8504021236574');

insert into ma_emp values ('erp009', '정우영',to_date('20080319','yyyy-mm-dd'),to_date('19811207','yyyy-mm-dd'),null, '001','002','007');
insert into ma_emp_private values('erp009','erperp_scfb25@gmail.com','서울시 종로구 카카오아파트 127-011','01064871523','8112071549782');

insert into ma_emp values ('erp010', '황인범',to_date('20040708','yyyy-mm-dd'),to_date('19940604','yyyy-mm-dd'),null, '001','004','010');
insert into ma_emp_private values('erp010','erperp_yellowintiger06@gmail.com','서울시 금천구 토트넘아파트 103-1522','01046125547','9406041245665');

insert into ma_emp values ('erp011', '황희찬',to_date('19980629','yyyy-mm-dd'),to_date('19790823','yyyy-mm-dd'),null, '001','004','006');
insert into ma_emp_private values('erp011','erperp_khwangso11@gmail.com','서울시 종로구 마포구 제일아파트 109-112','01064971226','7908231332654');
...
SELECT MCE.NO_EMP, MCE.NM_EMP, MCE.ENTER_DATE, MCE.BIRTH_DATE, MCE.RETIRE_DATE, MCE.CD_EMP, MCE.CD_JIK, MCE.CD_DEPT, MCE.USER_ID, MCE.USER_PWD, MCE.EMAIL, MCE.NM_ADDR, MCE.PHONE, MCE.NO_RES
